...
OdometryPublisher::OdometryPublisher()
{
	...
	nh_priv.param("scale_x", scale_x, 0.565486 / 360.0 / 2.15); // loosely base off of 360 counts per rev, 100mm wheels (which is 0.6283185 / 360.0)
	nh_priv.param("scale_y", scale_y, 0.565486 / 360.0 / 2.7);
...
void OdometryPublisher::encoderCallback(const std_msgs::Float32MultiArray::ConstPtr& encoders)
{
	...
	if(calibration_mode) odom.pose.pose.position.z = th; // need some way to check this w/o the quaternion
	else odom.pose.pose.position.z = 0.0;
